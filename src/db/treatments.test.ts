...
const ROW = { id: 3, label: "Metformine", frequency: "daily", reminder_time: "08:00", reminder_enabled: 1, created_at: "2024-06-01T09:00:00Z" };
const TREATMENT = { id: "3", label: "Metformine", frequency: "daily" as const, reminderTime: "08:00", reminderEnabled: true, createdAt: "2024-06-01T09:00:00Z" };
...
describe("createTreatment", () => {
  it("inserts and returns treatment with id", async () => {
    ...
    expect(mockDb.run).toHaveBeenCalledWith(
      ...
      expect.arrayContaining([data.label, data.frequency, data.reminderTime, 1]),
    );
  });
